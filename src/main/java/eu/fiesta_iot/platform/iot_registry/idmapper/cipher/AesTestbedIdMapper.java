...
public class AesTestbedIdMapper extends AesEntityIdMapper {
	...
	public AesTestbedIdMapper() throws NoSuchAlgorithmException,
	                             NoSuchPaddingException,
	                             InvalidKeySpecException {
		super(EntityType.TESTBED, key);
	}

	public AesTestbedIdMapper(String url) throws NoSuchAlgorithmException,
	                                       NoSuchPaddingException,
	                                       InvalidKeySpecException {
		super(EntityType.TESTBED, url, key);
	}
}
